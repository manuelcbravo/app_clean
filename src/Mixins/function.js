export default {
    methods: {
        ...
        errorSwal(title,texto){
            ...
            if(!this.isJsonString(texto)){

                var texto = (texto)? ((texto.responseText)? texto.responseText : texto ) : 'Something went wrong, please try again.'
        ...
        warningSwal(title, texto){
            ...
            var titulo = (title)?  title : 'something went wrong, please try again.'
            // }
